    ...
    <form action="" method="POST" class="p-4 bg-white shadow-sm rounded-4">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <textarea class="form-control @error('address') is-invalid @enderror" name="address" id="" cols="30" rows="5">{{old('city')}}</textarea>
                @error('address') <p class="text-danger">{{$message}}</p> @enderror
            </div>
        </div>
        <div class="d-flex flex-row justify-content-center mt-4">
            <button class="btn btn-lg btn-purple" type="submit">ثبت رکورد</button>
        </div>
    </form>
</x-layout>
